            ...
            if (parameterSchema.isMultipleEntryPoint) {
                ...
                anonymousMethods.forEach(function (smartContractMethodName) {
                    var method = function () {
                        ...
                        validateArgs(__spreadArray([smartContractMethodName], args), parameterSchema, smartContractMethodName);
...
var ContractMethod = /** @class */ (function () {
    ...
    ContractMethod.prototype.toTransferParams = function (_a) {
        ...
        return __assign(__assign(__assign({ to: this.address, amount: amount, parameters: {
                entrypoint: this.isMultipleEntrypoint
                    ? this.name
                    : DEFAULT_SMART_CONTRACT_METHOD_NAME,
                value: this.isAnonymous
                    ? (_b = this.parameterSchema).Encode.apply(_b, __spreadArray([this.name], this.args)) : (_c = this.parameterSchema).Encode.apply(_c, this.args),
            } }, (fee ? { fee: fee } : {})), (gasLimit ? { gasLimit: gasLimit } : {})), (storageLimit ? { storageLimit: storageLimit } : {}));
    };
