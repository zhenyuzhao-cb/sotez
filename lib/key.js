...
var Key = /** @class */ (function () {
    function Key(_a) {
         ...
         */
        this.secretKey = function (passphrase) {
            if (!_this._secretKey) {
            ...
            if (passphrase) {
                if (_this._curve === 'ed') {
                    key = libsodium_wrappers_sumo_1.default.crypto_sign_ed25519_sk_to_seed(key, 'uint8array');
                }
                var encryptionSalt = _this._salt || libsodium_wrappers_sumo_1.default.randombytes_buf(8);
                var encryptionKey = pbkdf2_1.default.pbkdf2Sync(passphrase, encryptionSalt, 32768, 32, 'sha512');
                var encryptedSk = libsodium_wrappers_sumo_1.default.crypto_secretbox_easy(new Uint8Array(key), new Uint8Array(24), new Uint8Array(encryptionKey));
                key = utility_1.mergebuf(encryptionSalt, encryptedSk);
            }
            return utility_1.b58cencode(key, constants_1.prefix["" + _this._curve + (passphrase ? 'e' : '') + "sk"]);
        };
        /**
         * @memberof Key
        ...
        this.publicKeyHash = function () {
            ...
            return utility_1.b58cencode(libsodium_wrappers_sumo_1.default.crypto_generichash(20, _this._publicKey), prefixMap[_this._curve]);
        };
        this.initialize = function (_a, setInit) {
            var key = _a.key, passphrase = _a.passphrase, email = _a.email;
            return __awaiter(_this, void 0, void 0, function () {
                var salt, seed, _b, publicKey, privateKey, encrypted, publicOrSecret, constructedKey, encryptedSk, encryptionKey, _c, publicKey, privateKey, keyPair, prefixVal, pad, keyPair, prefixVal, pad;
                    ...
                    switch (_d.label) {
                        ...
                        case 3:
                            if (email) {
                                ...
                                _b = libsodium_wrappers_sumo_1.default.crypto_sign_seed_keypair(new Uint8Array(seed.slice(0, 32))), publicKey = _b.publicKey, privateKey = _b.privateKey;
                            ...
                            if (encrypted) {
                                ...
                                encryptionKey = pbkdf2_1.default.pbkdf2Sync(passphrase, this._salt, 32768, 32, 'sha512');
                                constructedKey = libsodium_wrappers_sumo_1.default.crypto_secretbox_open_easy(new Uint8Array(encryptedSk), new Uint8Array(24), new Uint8Array(encryptionKey));
                            }
                            if (!this._isSecret) {
                                ...
                                if (this._curve === 'ed') {
                                    if (constructedKey.length === 64) {
                                        // sk
                                        this._publicKey = new Uint8Array(libsodium_wrappers_sumo_1.default.crypto_sign_ed25519_sk_to_pk(this._secretKey));
                                    }
                                    else {
                                        _c = libsodium_wrappers_sumo_1.default.crypto_sign_seed_keypair(constructedKey, 'uint8array'), publicKey = _c.publicKey, privateKey = _c.privateKey;
                                        this._publicKey = new Uint8Array(publicKey);
                                        this._secretKey = new Uint8Array(privateKey);
                                    }
                                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        bytesHash = libsodium_wrappers_sumo_1.default.crypto_generichash(32, bb);
                        if (!this._secretKey) {
                            throw new Error('Cannot sign operations without a secret key.');
                        }
                        if (this._curve === 'ed') {
                            signature = libsodium_wrappers_sumo_1.default.crypto_sign_detached(bytesHash, this._secretKey);
        ...
        this.verify = function (bytes, signature, publicKey) {
            ...
            var _publicKey = utility_1.b58cdecode(publicKey, constants_1.prefix[_curve + "pk"]);
            ...
            var bytesBuffer = libsodium_wrappers_sumo_1.default.crypto_generichash(32, utility_1.hex2buf(bytes));
            var sig;
            if (signature.substring(0, 3) === 'sig') {
            ...
            if (_curve === 'ed') {
                try {
                    return libsodium_wrappers_sumo_1.default.crypto_sign_verify_detached(sig, bytesBuffer, _publicKey);
                }
                catch (e) {
                    return false;
                }
